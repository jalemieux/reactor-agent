...
class FMPTool(Tool):
    def __init__(self):
        super().__init__(
            names=["fmp_api_doc"],
            description="Financial modeling prep api documentation.",
        )
        self.url = "https://site.financialmodelingprep.com/developer/docs/stable"
        self.headers = {
    ...
    def get_fmp_api_doc(self) -> str:
        file_path = "fmp_api_documentation.txt"
        if not os.path.exists(file_path):
            content = self._fetch_and_clean_url_content()
